...
public class LazyNetworkManager {
    ...
    public static void tickClient() {
        ...
        while (!serverQueue.isEmpty() && cooldownClient < 1.0) {
            ...
            cooldownClient += 20.0 / Config.COMMON.maxPacketsPerSecond;
        }
    }
    ...
    public static void tickServer() {
        ...
        while (!clientQueue.isEmpty() && cooldownServer < 1.0) {
            ...
            cooldownServer += 20.0 / Config.COMMON.maxPacketsPerSecond;
        }
    }

    public static float getRemainingTime() {
        return (float)serverQueue.size() / Config.COMMON.maxPacketsPerSecond;
    }
