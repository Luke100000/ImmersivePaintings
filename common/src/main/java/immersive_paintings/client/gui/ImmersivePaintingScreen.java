...
public class ImmersivePaintingScreen extends Screen {
    ...
    private void rebuild() {
        ...
        switch (page) {
            ...
            case DELETE -> {
                addDrawableChild(new ButtonWidget(width / 2 - 100 - 5, height / 2 + 20, 100, 20, new TranslatableText("immersive_paintings.cancel"), v -> setPage(Page.YOURS)));
            ...
            case ADMIN_DELETE -> {
                addDrawableChild(new ButtonWidget(width / 2 - 115, height / 2 + 10, 70, 20, new TranslatableText("immersive_paintings.cancel"), v -> setPage(Page.PLAYERS)));

                addDrawableChild(new ButtonWidget(width / 2 - 40, height / 2 + 10, 70, 20, new TranslatableText("immersive_paintings.delete"), v -> {
                    NetworkHandler.sendToServer(new PaintingDeleteRequest(deletePainting));
                    setPage(Page.PLAYERS);
                }));

                addDrawableChild(new ButtonWidget(width / 2 + 35, height / 2 + 10, 70, 20, new TranslatableText("immersive_paintings.delete_all"), v -> {
