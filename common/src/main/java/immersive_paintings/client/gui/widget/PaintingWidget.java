...
public class PaintingWidget extends ButtonWidget {
    ...
    public PaintingWidget(Painting.Texture thumbnail, int x, int y, int width, int height, PressAction onPress, PressAction onPressRight) {
        super(x, y, width, height, Text.literal("Painting"), onPress, ButtonWidget.DEFAULT_NARRATION_SUPPLIER);
